...
namespace GIOMAZ_THEME\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit(GIOMAZ_DIR_PATH), $directory, $file_name );
